...
<script type="text/javascript">
    window.onload = function(){
        ...
        $('.select-img').click(function(){
            ...
            $('.popwrap-img-lists').append('<li><label><div class="jue_pic"><img style="height:124px;" class="img-list" src="/frontend/web/files/QQ截图20171120093834.png"></div></label></li><li><label><div class="jue_pic"><img style="height:124px;" src="/frontend/web/files/QQ截图20171120163120.png"></div></label></li><li><label><div class="jue_pic"><img style="height:124px;" src="/frontend/web/files/QQ截图20171122135052.png"></div></label></li><li><label><div class="jue_pic"><img style="height:124px;" src="/frontend/web/files/QQ截图20171122151503.png"></div></label></li><li><label><div class="jue_pic"><img style="width:124px;" src="/frontend/web/files/panfish.9be67f5.png"></div></label></li><li><label><div class="jue_pic"><img style="width:124px;" src="/frontend/web/files/QQ截图20171220155930.png"></div></label></li><li><label><div class="jue_pic"><img style="height:124px;" class="img-list" src="/frontend/web/files/QQ截图20171120093834.png"></div></label></li><li><label><div class="jue_pic"><img style="height:124px;" src="/frontend/web/files/QQ截图20171120163120.png"></div></label></li><li><label><div class="jue_pic"><img style="height:124px;" src="/frontend/web/files/QQ截图20171122135052.png"></div></label></li><li><label><div class="jue_pic"><img style="height:124px;" src="/frontend/web/files/QQ截图20171122151503.png"></div></label></li><li><label><div class="jue_pic"><img style="width:124px;" src="/frontend/web/files/panfish.9be67f5.png"></div></label></li><li><label><div class="jue_pic"><img style="width:124px;" src="/frontend/web/files/QQ截图20171220155930.png"></div></label></li>');
